...
parameters1=c(p=1,alpha=0.1)
parameters2=c(p=1,alpha=0.2)
parameters3=c(p=1,alpha=0.3)
parameters4=c(p=1,alpha=0.4)
...
#st
windows(width=2000,height=1500)
plot(out211[,2]~out211[,1],type = "l",bty="l" ,col="red",xlab = "t",ylab ="S(t)",ylim=c(0,0.8),xlim=c(0,1))
